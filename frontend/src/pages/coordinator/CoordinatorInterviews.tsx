    ...
    const defaultInterviews: CoordinatorInterviewRecord[] = [
        {
            ...
            drive: "SDE",
            round: "Round 1",
            dateTime: "Sep 2, 10:00 AM",
            interviewer: "Arvind Kumar",
            status: "Scheduled",
            venue: "Lab 3 — Computer Center",
            coordinationNotes: "Student notified. Seat #14 reserved in Lab 3.",
            result: "Pending",
            feedback: "",
        ...
        },
        {
            ...
            drive: "Ninja",
            round: "Round 1",
            dateTime: "Sep 3, 11:30 AM",
            interviewer: "Suresh Raina",
            status: "Scheduled",
            venue: "Main Auditorium — Desk 4",
            coordinationNotes: "Pre-briefing complete. Desk 4 assigned.",
            result: "Pending",
            feedback: "",
            nextRound: "Pending Evaluation"
        },
        {
            ...
            drive: "SDE",
            round: "Round 2",
            dateTime: "Sep 5, 02:00 PM",
            interviewer: "Amazon Tech Panel",
            status: "Completed",
            venue: "Placement Cell Boardroom",
            coordinationNotes: "Round 2 technical interview completed.",
            result: "Selected",
            feedback: "Technical skills were good. Excellent problem-solving speed in Data Structures.",
            nextRound: "HR Round",
            updatedBy: "Prof. Rajesh Sharma (Coordinator)",
            updatedAt: "Sep 1, 2026, 4:30 PM"
        },
        {
            id: "inv_4",
            ...
            registerNo: "22CSR023",
            company: "Google",
            drive: "Cloud Engineer",
            round: "HR Round",
            dateTime: "Sep 6, 04:00 PM",
            originallyScheduledDate: "Sep 4, 02:00 PM",
            interviewer: "Google HR Panel",
            status: "Rescheduled",
            venue: "Conference Room B",
            coordinationNotes: "Rescheduled per recruiter schedule request.",
            result: "Pending",
            feedback: "",
            nextRound: "Pending Evaluation",
            reasonForChange: "Recruiter schedule update",
            updatedBy: "Prof. Rajesh Sharma (Coordinator)",
            updatedAt: "Aug 31, 2026, 3:15 PM"
        },
        {
            id: "inv_5",
            ...
            round: "Round 1",
            dateTime: "Aug 28, 09:30 AM",
            interviewer: "Infosys Tech Panel",
            status: "Completed",
            venue: "Lab 1 — Computer Center",
            coordinationNotes: "Interview round completed.",
            result: "Selected",
            feedback: "Strong fundamentals in Object Oriented Programming and SQL.",
            nextRound: "HR Round",
            updatedBy: "Karthik (Coordinator)",
            updatedAt: "Aug 28, 2026, 11:45 AM"
        }
    ];
