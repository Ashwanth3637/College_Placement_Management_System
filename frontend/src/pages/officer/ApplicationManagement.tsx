...
const ApplicationManagement: React.FC = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px", color: "#0f172a", fontFamily: "Inter, -apple-system, sans-serif" }}>
      ...
      {/* 2. Top Summary Cards (6 Metrics) Matching Dashboard Card Style */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "14px" }}>
        {[
          { label: "Total Applications", value: totalApps, sub: "Total received", color: "#4F46E5", bg: "#EEF2FF" },
          { label: "Applied", value: appliedCount, sub: "Newly submitted", color: "#2563EB", bg: "#EFF6FF" },
          { label: "In Progress", value: underReviewCount, sub: "In review queue", color: "#D97706", bg: "#FEF3C7" },
          { label: "Shortlisted", value: shortlistedCount, sub: "Screening passed", color: "#7C3AED", bg: "#F3E8FF" },
          { label: "Selected", value: selectedCount, sub: "Offers issued", color: "#16A34A", bg: "#DCFCE7" },
          { label: "Rejected", value: rejectedCount, sub: "Not selected", color: "#DC2626", bg: "#FEE2E2" }
        ].map((kpi, idx) => (
          <div
            key={idx}
            style={{
      ...
      {/* 4. Search & Filter Bar (All on Same Straight Line) */}
      <div style={{ backgroundColor: "#ffffff", padding: "14px 18px", borderRadius: "14px", border: "1px solid #E2E8F0", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(170px, 1fr))", gap: "10px", alignItems: "center", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
        <input
          type="text"
        ...
        <select
          ...
          style={{ width: "100%", padding: "9px 12px", borderRadius: "8px", border: "1px solid #CBD5E1", fontSize: "13px", backgroundColor: "#FFFFFF", cursor: "pointer", color: "#0F172A", fontWeight: "600", outline: "none", boxSizing: "border-box" }}
        >
        ...
        <select
          ...
          style={{ width: "100%", padding: "9px 12px", borderRadius: "8px", border: "1px solid #CBD5E1", fontSize: "13px", backgroundColor: "#FFFFFF", cursor: "pointer", color: "#334155", outline: "none", boxSizing: "border-box" }}
        >
