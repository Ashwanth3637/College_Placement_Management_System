        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "14px" }}>
                <div style={{ backgroundColor: "#ffffff", padding: "16px 20px", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
                    <div style={{ fontSize: "12px", fontWeight: "700", color: "#64748b", textTransform: "uppercase" }}>Total Interviews</div>
                    <div style={{ fontSize: "26px", fontWeight: "800", color: "#0f172a", marginTop: "4px" }}>{totalCount}</div>
                </div>
                <div style={{ backgroundColor: "#ffffff", padding: "16px 20px", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
                    <div style={{ fontSize: "12px", fontWeight: "700", color: "#b45309", textTransform: "uppercase" }}>Scheduled</div>
                    <div style={{ fontSize: "26px", fontWeight: "800", color: "#d97706", marginTop: "4px" }}>{scheduledCount}</div>
                </div>
                <div style={{ backgroundColor: "#ffffff", padding: "16px 20px", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
                    <div style={{ fontSize: "12px", fontWeight: "700", color: "#1d4ed8", textTransform: "uppercase" }}>Today</div>
                    <div style={{ fontSize: "26px", fontWeight: "800", color: "#2563eb", marginTop: "4px" }}>{todayCount}</div>
                </div>
                <div style={{ backgroundColor: "#ffffff", padding: "16px 20px", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
                    <div style={{ fontSize: "12px", fontWeight: "700", color: "#15803d", textTransform: "uppercase" }}>Completed</div>
                    <div style={{ fontSize: "26px", fontWeight: "800", color: "#16a34a", marginTop: "4px" }}>{completedCount}</div>
                </div>
                <div style={{ backgroundColor: "#ffffff", padding: "16px 20px", borderRadius: "12px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
                    <div style={{ fontSize: "12px", fontWeight: "700", color: "#b91c1c", textTransform: "uppercase" }}>Cancelled</div>
                    <div style={{ fontSize: "26px", fontWeight: "800", color: "#dc2626", marginTop: "4px" }}>{cancelledCount}</div>
                </div>
            </div>
