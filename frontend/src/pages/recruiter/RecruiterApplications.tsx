...
export const RecruiterApplications: React.FC<RecruiterApplicationsProps> = ({ user, onViewApplication }) => {
    ...
    // Synchronized Initial Applications Data with Standardized Workflow States
    const initialApplications: RecruiterApplicationItem[] = [
        {
            ...
            remarks: "Strong technical core in Java & Data Structures. Round 1 Technical Assessment evaluation in progress.",
            history: [
                { date: "24 Aug 2026", title: "Application Submitted", desc: "Applied for Software Developer drive", status: "Passed ✓", roundNumber: 1 },
                { date: "25 Aug 2026", title: "Academic & Profile Verification", desc: "Profile verified by Placement Cell", status: "Passed ✓", roundNumber: 1 },
                { date: "26 Aug 2026", title: "Round 1: Technical Assessment", desc: "Online coding assessment evaluation in progress", status: "In Progress ⏳", roundNumber: 1 }
            ]
        },
        {
            id: "app_2",
            ...
            currentRound: 1,
            roundStatus: "Passed",
            roundName: "Round 1: Technical Assessment Passed",
            remarks: "High CGPA 8.7 in IT department. Passed Round 1 Technical Assessment (88%) and shortlisted for interview.",
            history: [
                { date: "23 Aug 2026", title: "Application Submitted", desc: "Applied for Software Developer drive", status: "Passed ✓", roundNumber: 1 },
                { date: "24 Aug 2026", title: "Academic & Profile Verification", desc: "Cleared preliminary resume screening", status: "Passed ✓", roundNumber: 1 },
                { date: "26 Aug 2026", title: "Passed Round 1: Technical Assessment", desc: "Scored 88% in Online Technical Assessment", status: "Passed ✓", roundNumber: 1 }
            ]
        },
        {
            id: "app_3",
            ...
            currentRound: 1,
            roundStatus: "In Progress",
            roundName: "Round 1: Screening & Verification",
        ...
        },
        {
            ...
            currentRound: 2,
            roundStatus: "Evaluation Pending",
            roundName: "Round 2: Technical Interview Completed",
            remarks: "Round 2 Technical Interview conducted on 30 Aug 2026. Interview evaluation completed; pending final recruiter decision.",
            history: [
                { date: "21 Aug 2026", title: "Application Submitted", desc: "Applied for Cloud Engineer drive", status: "Passed ✓", roundNumber: 1 },
                { date: "23 Aug 2026", title: "Passed Round 1: Assessment", desc: "Scored 92% in Online Assessment", status: "Passed ✓", roundNumber: 1 },
                { date: "25 Aug 2026", title: "Advanced to Round 2: Technical Interview", desc: "Scheduled for Technical Interview", status: "Passed ✓", roundNumber: 2 },
                { date: "30 Aug 2026", title: "Round 2: Technical Interview Conducted", desc: "Interview completed with Senior Technical Lead", status: "Completed ✓", roundNumber: 2 },
                { date: "31 Aug 2026", title: "Round 2 Evaluation", desc: "Pending recruiter final decision", status: "Evaluation Pending ⏳", roundNumber: 2 }
            ],
            interviewSchedule: {
                date: "30 Aug 2026",
                time: "03:30 PM IST",
                location: "Online — Amazon Chime",
                mode: "Online",
        ...
        },
        {
            ...
            roundStatus: "Passed",
            roundName: "Completed",
            remarks: "Top ranker (CGPA 9.1). Cleared Technical Assessment, Technical Interview, and HR Bar Raiser with HR Director.",
            history: [
                ...
                { date: "26 Aug 2026", title: "Passed Round 3: HR Bar Raiser", desc: "Cleared HR evaluation with HR Director", status: "Passed ✓", roundNumber: 3 },
                { date: "27 Aug 2026", title: "Selected & Offer Released", desc: "Official offer letter dispatched", status: "Selected 🎉", roundNumber: 3 }
            ]
        }
    ];
    ...
    const fetchApplicationsData = async () => {
        setIsLoading(true);
        let list: RecruiterApplicationItem[] = [...initialApplications];
